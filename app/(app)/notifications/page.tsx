                ...
                return (
                  <div key={r.id} className="rounded-xl border border-gray-100 p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {TRIGGER_LABELS[r.triggerBefore]} · {formatDate(r.createdAt)}
                        </p>
                        {r.message && (
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2">
                      <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs bg-indigo-50 text-indigo-700 capitalize">
                        {r.type}
                      </span>
